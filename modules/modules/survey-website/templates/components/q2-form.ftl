...
<form id="${content.title?default("form0")}" method="post" action="" enctype="${def.parameters.formEnctype?default("multipart/form-data")}" >
      <div class="form-item-hidden">
        ...
        <div class="tab"><span style="font-size: 40px; color: #216478;margin-left: 80px;"> The impact of your Value Profile </span>
          ...
          <div class="row">
           <span style="font-size: 20px; margin-left: 100px;margin-right: 200px;"> ${content.desc!"Complete the following three instructions for each of the above items in your “use the most list. "}</span>
          </div>
          <table class="table">
            <tbody>
              <tr>
                ...
                <td>
                    <div class="row" style="
                      ...
                      ">
                      <span>
                          <p class="text-center">${content.detail!"Of all of the items in your entire completed Value Pro le Matrix, which ones do you use in the real world the most?"}</p>
                      </span>
                    </div>
                </td>
                <td>
                    <div class="row" style="margin-right: 50px;">
                      <span>
                       ...
                       <select name="q2a1" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                          [#if currentQ2?has_content && currentQ2.q2a1?has_content]
                            [@generateOptions  currentQ2.q2a1 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                        </select>
                       <select name="q2a2" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ2?has_content && currentQ2.q2a2?has_content]
                            [@generateOptions  currentQ2.q2a2 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]

                      </select>
                       <select name="q2a3" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                        [#if currentQ2?has_content && currentQ2.q2a3?has_content]
                            [@generateOptions  currentQ2.q2a3 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
                       <select name="q2a4" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ2?has_content && currentQ2.q2a4?has_content]
                            [@generateOptions  currentQ2.q2a4 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
                       <select name="q2a5" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ2?has_content && currentQ2.q2a5?has_content]
                            [@generateOptions  currentQ2.q2a5 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
