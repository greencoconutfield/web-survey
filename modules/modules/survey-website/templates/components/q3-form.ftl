              ...
              <tr>
                ...
                <td>
                    <div class="row" style="
                      ...
                      ">
                      <span>
                          <p class="text-center">Which of the ten items on your ‘Use the Least’ and ‘Use the most’ lists have you already applied to Your Focus Challenge?</p>
                      </span>
                    </div>
                </td>
                <td>
                    <div class="row" style="margin-right: 50px;">
                      <span>
                          <p class="text-center" style="
                            font-size: 30px;
                            font-weight: bold;
                            ">Already Applied List </p>
                      </span>
                       <select name="q3a1" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                           [#if currentQ3?has_content && currentQ3.q3a1?has_content]
                            [@generateOptions  currentQ3.q3a1 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                        </select>
                       <select name="q3a2" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ3?has_content && currentQ3.q3a2?has_content]
                            [@generateOptions  currentQ3.q3a2 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]

                      </select>
                       <select name="q3a3" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                       [#if currentQ3?has_content && currentQ3.q3a3?has_content]
                            [@generateOptions  currentQ3.q3a3 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
                       <select name="q3a4" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ3?has_content && currentQ3.q3a4?has_content]
                            [@generateOptions  currentQ3.q3a4 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
                       <select name="q3a5" class="form-control" style="margin-top: 10px;margin-bottom: 10px; height: 50px;" id="exampleFormControlSelect1">
                         [#if currentQ3?has_content && currentQ3.q3a5?has_content]
                            [@generateOptions  currentQ3.q3a5 /]
                          [#else]
                            [@generateOptions  "" /]
                          [/#if]
                      </select>
