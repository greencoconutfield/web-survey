...
[#if current?has_content]
  [#assign currentImpactMost = cmsfn.contentByPath("/"+currentUser +"/impact-most" , "ksa")! /]
...
<form id="${content.title?default("form0")}" method="post" action="" enctype="${def.parameters.formEnctype?default("multipart/form-data")}" >
      <div class="form-item-hidden">
        ...
        <div class="tab"><span style="font-size: 40px; color: #216478;margin-left: 80px;"> The impact of your Value Profile </span>
          ...
          <div class="row">
           <span style="font-size: 20px; margin-left: 100px;margin-right: 200px;"> ${content.desc!'Complete the following three instructions for each of the above items in your <span style="font-weight: bold;"> “use the most” </span> list.'}</span>
          </div>
          <table class="table">
            <tbody>
                <tr>
                  ...
                  <td> 
                    <div class="row" style="margin-left: 1px;margin-right: 1px;text-align: center;display: grid;">
                      <span> <p class="text-center" style="font-weight: bold">[#if currentQ2?has_content && currentQ2.q2a1?has_content] ${currentQ2.q2a1} [#else] Use the most list Item 1 [/#if] </p></span>
                    </div>
                  <td>
                    <div class="row" style="margin-left: 1px;margin-right: 1px;text-align: center;display: grid;">
                      <span> <p class="text-center" style="font-weight: bold">[#if currentQ2?has_content && currentQ2.q2a2?has_content] ${currentQ2.q2a2} [#else] Use the most list Item 2 [/#if] </p></span>
                    </div>
                  </td>
                  <td>
                    <div class="row" style=";margin-left: 1px;margin-right: 1px;text-align: center;display: grid;">
                      <span> <p class="text-center" style="font-weight: bold">[#if currentQ2?has_content && currentQ2.q2a3?has_content] ${currentQ2.q2a3} [#else] Use the most list Item 3 [/#if] </p></span>
                    </div>
                  </td>
                  <td>
                    <div class="row" style=";margin-left: 1px;margin-right: 1px;text-align: center;display: grid;">
                      <span> <p class="text-center" style="font-weight: bold">[#if currentQ2?has_content && currentQ2.q2a4?has_content] ${currentQ2.q2a4} [#else] Use the most list Item 4 [/#if] </p></span>
                    </div>
                  </td>
                  <td>
                    <div class="row" style=";margin-left: 1px;margin-right: 1px;text-align: center;display: grid;">
                      <span> <p class="text-center" style="font-weight: bold">[#if currentQ2?has_content && currentQ2.q2a5?has_content] ${currentQ2.q2a5} [#else] Use the most list Item 5 [/#if] </p></span>
                    </div>
                  </td>
                </tr>
                 <tr>
                  ...
                  <td>
                      <textarea name="im11" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im11?has_content] ${currentImpactMost.im11} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im12" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im12?has_content] ${currentImpactMost.im12} [/#if]</textarea>
                  </td>
                 <td>
                     <textarea name="im13" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im13?has_content] ${currentImpactMost.im13} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im14" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im14?has_content] ${currentImpactMost.im14} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im15" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im15?has_content] ${currentImpactMost.im15} [/#if]</textarea>
                  </td>
                </tr>
                 <tr>
                  <th>
                  ...
                  <td>
                      <textarea name="im21" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im21?has_content] ${currentImpactMost.im21} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im22" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im22?has_content] ${currentImpactMost.im22} [/#if]</textarea>
                  </td>
                 <td>
                      <textarea name="im23" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im24?has_content] ${currentImpactMost.im24} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im24" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im11?has_content] ${currentImpactMost.im11} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im25" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im25?has_content] ${currentImpactMost.im25} [/#if]</textarea>
                  </td>
                </tr>
                 <tr>
                  <th>
                  ...
                  <td>
                     <textarea name="im31" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im31?has_content] ${currentImpactMost.im31} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im32" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im32?has_content] ${currentImpactMost.im32} [/#if]</textarea>
                  </td>
                 <td>
                     <textarea name="im33" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im33?has_content] ${currentImpactMost.im33} [/#if]</textarea>                

                  </td>
                  <td>
                     <textarea name="im34" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im34?has_content] ${currentImpactMost.im34} [/#if]</textarea>
                  </td>
                  <td>
                     <textarea name="im35" class="form-control" id="exampleFormControlTextarea1" rows="5"> [#if currentImpactMost?has_content && currentImpactMost.im35?has_content] ${currentImpactMost.im35} [/#if]</textarea>
                  </td>
                </tr>
            </tbody>
          </table>
