...
This package contains:
   ...
   Magnolia Core 6.2.3
   Magnolia empty webapp 6.2.3
   Magnolia empty webapp 6.2.3
   Magnolia Internationalization Framework 6.2.3
   Magnolia JAAS 6.2.3
   Magnolia Mail module 5.5.6
   magnolia-module-rssaggregator 2.6.3
   Magnolia Rendering 6.2.3
   Magnolia Templating 6.2.3
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.3.html
